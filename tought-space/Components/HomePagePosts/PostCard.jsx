  ...
  return (
    <div className="bg-white bg-opacity-90 backdrop:blur-lg shadow-xl flex p-3 flex-col gap-y-5 overflow-hidden text-white justify-around rounded-xl w-full">
      ...
      <div className="flex justify-between items-center">
        ...
        <Link className="px-3 py-2 shadow-lg bg-blue-800 text-white rounded-lg text-base duration-150 ease-in-out hover:bg-blue-600 max-md:px-2 max-md:py-1 max-md:text-sm max-sm:px-2 max-sm:py-1 max-sm:text-sm" href={`/${post.id}`}>See more</Link>
      </div>
